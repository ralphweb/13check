...
.app {
    ...
    {
      flex:0 0 50px;
      border-right: 1px solid $space-cadet;
    ...
    .content {
        ...
        .middle {
            ...
            border-bottom: 1px solid $space-cadet;
            display: flex;
            justify-content: flex-start;
            align-items: center;
            flex: 0 0 auto;
              ...
              .col
              {
                ...
                .btn
                {
                  ...
                  &-closed
                  {
                    ...
                    align-items: center;
                    color: white;
                    background-color: $lablab-purple;
                    border-color: $lablab-purple;
                  }
                  ...
                  &-resolved
                  {
                    ...
                    align-items: center;
                    color: white;
                    background-color: $lablab-green;
                    border-color: $lablab-green;
                  }
    ...
    .chat
    {
      ...
      .message {
        ...
        &.bot {
          .message-box {
            color: white;
            background-color: rgb(239, 82, 80);
          }
        }
