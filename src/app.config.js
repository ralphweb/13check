const CONFIG = {
    ...
    api_hostname: process.env.VUE_APP_API_HOSTNAME || "https://13checkapi.ingenieriac13.cl",
    api_url: process.env.VUE_APP_API_URL || "https://13checkapi.ingenieriac13.cl/api/",
