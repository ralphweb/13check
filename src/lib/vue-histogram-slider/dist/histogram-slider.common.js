...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"18c296ab-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/lib/HistogramSlider.vue?vue&type=template&id=14a4e754&
...
// CONCATENATED MODULE: ./src/lib/HistogramSlider.vue?vue&type=template&id=14a4e754&
  ...
  IonRangeSlider.prototype = {
    ...
    calc: function calc(update) {
      ...
      if (this.options.type === 'single') {
        ...
        this.result.from_pretty = this._prettify(this.result.from).substr(3);
      ...
      if (this.options.type === 'single') {
        ...
        if (values_num) {
          ...
          if (this.options.decorate_both) {
            ...
            text_single = this.decorate(from_pretty + this.options.values_separator + to_pretty, this.result.to) + "SINGLE";
          }
    ...
    validate: function validate() {
      ...
      if (vl) {
        ...
        for (i = 0; i < vl; i++) {
          ...
          if (!isNaN(value)) {
            v[i] = value;
            value = this._prettify(value).substr(3);
          } else {
            value = v[i];
          }
...
/* harmony default export */ var HistogramSlidervue_type_script_lang_js_ = ({
  ...
  mounted: function mounted() {
    ...
    if (this.clip) {
      brush = brushX().on('end', function () {
        var extent = on_event.selection;
